...
* I would recommend creating your own reload.sh based on the tools you use. This script should do things like reload your window manager, set your wallpaper, reload bars/launchers with their new theme, etc
